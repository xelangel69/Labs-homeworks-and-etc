...
/**
 * Абстрактный класс {@code characters.Persona}, представляющий базовую сущность персонажа в симуляции.
 * <p>
...
public abstract class Persona implements MovingTo, EmotionalState {
     ...
     * <p>
     * Базовая реализация устанавливает настроение в {@code characters.Mood.DEFAULT}.
